...
% Take effectively log to the base 2 of p
...
for i = 1 : mbSize : row-mbSize+1
    for j = 1 : mbSize : col-mbSize+1
        ...
        while(stepSize >= 1)  
            ...
            [dx, dy, min] = minCost2(costs);      % finds which macroblock in imgI gave us min Cost
            ...
            % At this point we can check and see if the
...
title('Three Step Search Motion Vector');
camroll(270);
motionVect = vectors;
